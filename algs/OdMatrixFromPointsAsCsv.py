...
class OdMatrixFromPointsAsCsv(QgisAlgorithm):
    ...
    def displayName(self):
        return ja(NEO_PREFIX + 'OD 行列（ポイント・CSV n:n）')

    def shortHelpString(self):
        return help_od_matrix_points_csv()
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFileDestination(self.OUTPUT, ja(UIS.OUTPUT_OD_MATRIX), ja(UIS.CSV_FILES_FILTER)),True)
