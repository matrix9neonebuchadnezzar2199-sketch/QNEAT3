...
from QNEAT3.Qneat3HelpJa import help_iso_interpolation_from_point
...
class IsoAreaAsInterpolationFromPoint(QgisAlgorithm):
    ...
    def icon(self):
        return QIcon(icon_path('icon_servicearea_interpolation.png'))
    ...
    def shortHelpString(self):
        return help_iso_interpolation_from_point()
