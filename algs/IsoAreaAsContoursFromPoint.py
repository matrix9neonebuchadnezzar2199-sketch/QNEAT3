...
from QNEAT3.Qneat3HelpJa import help_iso_contours_from_point
...
class IsoAreaAsContoursFromPoint(QgisAlgorithm):
    ...
    def icon(self):
        return QIcon(icon_path('icon_servicearea_contour.svg'))
    ...
    def displayName(self):
        return ja(NEO_PREFIX + '等時圏等値線（単一点）')

    def shortHelpString(self):
        return help_iso_contours_from_point()
