...
from QNEAT3.Qneat3HelpJa import help_iso_contours_from_layer
...
class IsoAreaAsContoursFromLayer(QgisAlgorithm):
    ...
    def icon(self):
        return QIcon(icon_path('icon_servicearea_contour_multiple.svg'))
    ...
    def displayName(self):
        return ja(NEO_PREFIX + '等時圏等値線（レイヤ）')

    def shortHelpString(self):
        return help_iso_contours_from_layer()
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSink(self.OUTPUT_CONTOURS, ja(UIS.OUTPUT_ISO_CONTOURS), QgsProcessing.TypeVectorLine))
